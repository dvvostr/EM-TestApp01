...
extension UIColor {
    public struct Preset {
        ...
        internal static var excelentBackground: UIColor {
            return UIColor(named: "colorExcelentBackground") ?? defaultNegative.withAlphaComponent(0.20)
        }
        internal static var excelentForeground: UIColor {
            return UIColor(named: "colorExcelentForeground") ?? defaultNegative.withAlphaComponent(0.20)
        }
